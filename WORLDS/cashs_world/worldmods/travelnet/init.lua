...
travelnet.on_receive_fields = function(pos, formname, fields, player)
   ...
   if( travelnet.travelnet_sound_enabled ) then
      minetest.sound_play("teleporters_teleport", {pos = pos, gain = 1.0, max_hear_distance = 10,})
   end
   ...
   if( travelnet.travelnet_sound_enabled ) then
      minetest.sound_play("teleporters_teleport", {pos = target_pos, gain = 1.0, max_hear_distance = 10,})
   end
   if( travelnet.travelnet_effect_enabled ) then
