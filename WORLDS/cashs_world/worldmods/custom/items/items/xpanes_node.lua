...
function xpanes.register_pane(name, def)
    -- Why is this done? Why is this done 15 times?
    -- Guess: Compatibility with an older version or another mod
    -- JDC
	for i = 1, 15 do
		minetest.register_alias("xpanes:" .. name .. "_" .. i, "custom:" .. name .. "_flat")
	end

	local flatgroups = table.copy(def.groups)
	flatgroups.pane = 1
	minetest.register_node(":custom:" .. name .. "_flat", {
	...
	minetest.register_node(":custom:" .. name, {
		drawtype = "nodebox",
		paramtype = "light",
		is_ground_content = false,
		sunlight_propagates = true,
...
xpanes.register_pane("pane", {
	...
	textures = {"custom_glass.png","custom_glasspane_half.png","custom_glasspane_white.png"},
	inventory_image = "custom_glass.png",
	wield_image = "custom_glass.png",
...
xpanes.register_pane("bar", {
	...
	textures = {"custom_bar.png","custom_bar.png","custom_bar_top.png"},
	inventory_image = "custom_bar.png",
	wield_image = "custom_bar.png",
	groups = {snappy=2, cracky=3, oddly_breakable_by_hand=3},
