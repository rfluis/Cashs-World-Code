...
["keypad"] = {item = "basic_machines:keypad", description = "Turns on/off lights and activates machines or opens doors", craft = {"custom:wood","custom:stick"}, tex  = "keypad"},
["light"]={item = "basic_machines:light_on", description = "Light in darkness", craft = {"custom:torch 4"}, tex  = "light"},
["mover"]={item = "basic_machines:mover", description = "Can dig, harvest, plant, teleport or move items from/in inventories", craft = {"custom:mese_crystal 6","custom:stone 2", "basic_machines:keypad"}, tex = "basic_machine_mover_side"},

["detector"] = {item = "basic_machines:detector", description = "Detect and measure players, objects,blocks,light level", craft = {"custom:mese_crystal 4","basic_machines:keypad"}, tex = "detector"},

["distributor"]= {item = "basic_machines:distributor", description = "Organize your circuits better", craft = {"custom:steel_ingot","custom:mese_crystal", "basic_machines:keypad"}, tex = "distributor"},

["clock_generator"]= {item = "basic_machines:clockgen", description = "For making circuits that run non stop", craft = {"custom:diamondblock","basic_machines:keypad"}, tex = "basic_machine_clock_generator"},

["recycler"]= {item = "basic_machines:recycler", description = "Recycle old tools", craft = {"custom:mese_crystal 8","custom:diamondblock"}, tex = "recycler"},
...
["battery"]={item = "basic_machines:battery", description = "Power for machines", craft = {"custom:steel_ingot 3","custom:mese","custom:diamond"}, tex = "basic_machine_battery"},

["generator"]={item = "basic_machines:generator", description = "Generate power crystals", craft = {"custom:diamondblock 5","basic_machines:battery"}, tex = "basic_machine_generator"},

["autocrafter"] = {item = "basic_machines:autocrafter", description = "Automate crafting", craft = { "custom:steel_ingot 5", "custom:mese_crystal 2", "custom:diamondblock 2"}, tex = "pipeworks_autocrafter"},

["grinder"] = {item = "basic_machines:grinder", description = "Makes dusts and grinds materials", craft = {"custom:diamond 13","custom:mese 4"}, tex = "grinder"},
}
...
minetest.register_node("basic_machines:constructor", {
	...
	tiles = {"grinder.png","custom_furnace_top.png", "basic_machine_side.png","basic_machine_side.png","basic_machine_side.png","basic_machine_side.png"},
