...
local enviro_update_form = function (pos)
		...
		"button_exit[3.25,3.25;1,1;OK;OK]".. "button[4.25,3.25;1.5,1;help;help]"..
...
minetest.register_node("basic_machines:enviro", {
	...
	mesecons = {effector = {
		action_on = function (pos, node,ttl)
			...
			local inv = meta:get_inventory(); local stack = ItemStack("custom:diamond 1");
	...
	on_receive_fields = function(pos, formname, fields, sender)
		...
		if fields.help then
			local text = "Enviro Help text - To Be Written";
...
-- minetest.register_node("basic_machines:air", {
	...
	-- drawtype = "liquid",
	-- tiles =  {"custom_water_source_animated.png"},
