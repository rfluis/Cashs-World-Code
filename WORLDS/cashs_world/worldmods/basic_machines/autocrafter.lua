...
minetest.register_node("basic_machines:autocrafter", {
	...
	groups = {tubedevice = 1, tubedevice_receiver = 1, oddly_breakable_by_hand=2},
	...
	on_receive_fields = function(pos, formname, fields, sender)
		if fields.help then
			local text = "Autocrafter Help Text - To Be Written";
...
-- minetest.register_craft( {
	...
	-- recipe = {
	        -- { "custom:steel_ingot", "custom:mese_crystal", "custom:steel_ingot" },
	        -- { "custom:diamondblock", "custom:steel_ingot", "custom:diamondblock" },
	        -- { "custom:steel_ingot", "custom:mese_crystal", "custom:steel_ingot" }
	-- },
-- })
