...
basic_machines.ball = {};
basic_machines.ball.maxdamage  =  8;  -- player health 20
...
local ball_spawner_update_form = function (pos)
		...
		"button[2,4.25;1,1;help;help]".."button_exit[3.25,4.25;1,1;OK;OK]";
	...
	on_step = function(self, dtime)
		...
		if walkable then -- we hit a node
			...
			if table and table.mesecons and table.mesecons.effector then -- activate target
				...
				minetest.sound_play("custom_dig_cracky", {pos=pos,gain=1.0,max_hear_distance = 8,})
...
minetest.register_node("basic_machines:ball_spawner", {
	...
	on_receive_fields = function(pos, formname, fields, sender)
		...
		if fields.help then
			local text = "Ball_Spawner Help Text - To Be Written";
