...
local old_bucket_water_on_place=minetest.registered_craftitems["custom:bucket_water"].on_place
minetest.registered_craftitems["custom:bucket_water"].on_place=function(itemstack, placer, pointed_thing)
...
local old_bucket_lava_on_place=minetest.registered_craftitems["custom:bucket_lava"].on_place
minetest.registered_craftitems["custom:bucket_lava"].on_place=function(itemstack, placer, pointed_thing)
	local pos = pointed_thing.above
	if city_block:in_city(pos) then
        minetest.chat_send_player(placer:get_player_name(), "Don't do that in town!")
        return itemstack
