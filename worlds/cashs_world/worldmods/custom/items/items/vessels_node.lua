...
minetest.register_node("custom:vessels_shelf", {
...
minetest.register_node("custom:glass_bottle", {
...
minetest.register_node("custom:drinking_glass", {
...
minetest.register_craft( {
	output = "custom:drinking_glass 14",
	recipe = {
		{"custom:glass", "", "custom:glass"},
		{"custom:glass", "", "custom:glass"},
...
minetest.register_node("custom:steel_bottle", {
...
minetest.register_craftitem("custom:glass_fragments", {
...
minetest.register_craft({
	type = "cooking",
	output = "custom:glass",
	recipe = "custom:glass_fragments",
})

minetest.register_craft( {
	type = "cooking",
	output = "custom:steel_ingot",
	recipe = "custom:steel_bottle",
})
