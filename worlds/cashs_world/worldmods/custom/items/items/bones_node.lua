...
minetest.register_node("custom:bones", {
	description = "Bones",
	tiles = {
		"custom_bones_top.png",
		"custom_bones_bottom.png",
		"custom_bones_side.png",
		"custom_bones_side.png",
		"custom_bones_rear.png",
		"custom_bones_front.png"
	},
	paramtype2 = "facedir",
	groups = {dig_immediate=2},
	sounds = default.node_sound_dirt_defaults({
		footstep = {name="custom_gravel_footstep", gain=0.5},
		dug = {name="custom_gravel_footstep", gain=1.0},
	}),
	...
	on_punch = function(pos, node, player)
		...
		if has_space then
			if player_inv:room_for_item("main", {name = "custom:bones"}) then
				player_inv:add_item("main", {name = "custom:bones"})
			else
				minetest.add_item(pos,"custom:bones")
			end
			minetest.remove_node(pos)
		end
	end,
...
minetest.register_on_dieplayer(function(player)
	...
	minetest.set_node(pos, {name="custom:bones", param2=param2})
