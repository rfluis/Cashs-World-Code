...
-- Converted from using meshes back to using nodboxes - JDC
-- Added 'not_in_craft_guide=1' to 'groups'
...
--	collision_box = {
	...
	tiles = {
		...
		"custom_steel_block.png",  -- view from top
		"custom_clay.png",  -- view from bottom
	},
