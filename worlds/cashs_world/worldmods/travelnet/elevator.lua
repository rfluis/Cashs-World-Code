...
--		recipe = {
--                        {"custom:steel_ingot", "technic:motor", "custom:steel_ingot", },
--                	{"custom:steel_ingot", "technic:control_logic_unit", "custom:steel_ingot", },
--                	{"custom:steel_ingot", "moreores:copper_ingot", "custom:steel_ingot", }
--                }
--        })
--else
--	minetest.register_craft({
