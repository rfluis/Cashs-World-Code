...
local no_recycle_list  = {
	["custom:steel_ingot"]=1,["custom:copper_ingot"]=1,["custom:bronze_ingot"]=1,["custom:gold_ingot"]=1,
...
minetest.register_node("basic_machines:recycler", {
	...
	on_receive_fields = function(pos, formname, fields, sender)
		...
		if fields.help then
			local text = "Recycler Help Text - To Be Written";
...
-- minetest.register_craft({
	...
	-- recipe = {
		...
		-- {"custom:mese_crystal","custom:diamondblock","custom:mese_crystal"},
		-- {"custom:mese_crystal","custom:mese_crystal","custom:mese_crystal"},
