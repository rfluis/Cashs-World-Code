...
basic_machines.grinder_recipes = {
	["custom:stone"] = {2,"custom:sand",1},
	["custom:cobble"] = {1,"custom:gravel",1},
	["custom:gravel"] = {0.5,"custom:dirt",1},
	["custom:dirt"] = {0.5,"custom:clay_lump 4",1},
	...
	["gloopblocks:basalt"] = {1, "custom:cobble",1}, -- enable cobble farms with gloopblocks mod
};
...
local grinder_process = function(pos)
	...
	-- process items
		...
		minetest.sound_play("grinder", {pos=pos,gain=0.2,max_hear_distance = 10,})
...
local grinder_update_meta = function(pos)
		...
		"button[6.5,0.5;1,1;OK;OK]" .. "button[6.5,1.5;1,1;help;help]";
...
minetest.register_node("basic_machines:grinder", {
	...
	on_receive_fields = function(pos, formname, fields, sender)
		...
		if fields.help then
			local text = "Grinder Help Text - To Be Written";
...
-- minetest.register_craft({
	...
	-- recipe = {
		-- {"custom:diamond","custom:mese","custom:diamond"},
		-- {"custom:mese","custom:diamondblock","custom:mese"},
		-- {"custom:diamond","custom:mese","custom:diamond"},
...
register_dust("iron","custom:iron_lump","custom:steel_ingot",4,8,"99","99","99")
register_dust("copper","custom:copper_lump","custom:copper_ingot",4,8,"C8","80","0D") --c8800d
register_dust("gold","custom:gold_lump","custom:gold_ingot",6,25,"FF","FF","00")

--  grinding ingots gives dust too
basic_machines.grinder_recipes["custom:steel_ingot"] = {4,"basic_machines:iron_dust_33 2",1};
basic_machines.grinder_recipes["custom:copper_ingot"] = {4,"basic_machines:copper_dust_33 2",1};
basic_machines.grinder_recipes["custom:gold_ingot"] = {6,"basic_machines:gold_dust_33 2",1};
...
register_dust("mese","custom:mese_crystal","custom:mese_crystal",8,250,"CC","CC","00")
register_dust("diamond","custom:diamond","custom:diamond",16,500,"00","EE","FF") -- 0.3hr cooking time to make diamond!
